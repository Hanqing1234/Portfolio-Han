...
import myLeetcode from "../../assets/screenshots/leetcode.jpg";
...
import leetcode from "../../assets/icons/leetcode.jpg";
import leetcode2 from "../../assets/icons/leetcode.png";
...
export const projects: ProjectItem[] = [
  {
    ...
    description: (
      <div>
        <p>
          A website that customers can submit technical ticket of their
          products.
          <br />
          <br />
          Registered users can login and process tickets to different user
          roles.
          <br />
          <br />
    ...
    links: [
      ...
      {
        content: "https://github.com/Hanqing1234/react-TQ-system",
        image: github,
      },
    ],
    techUsed: [
    ...
    description: (
      <div>
        <p>
          ...
          <br />
          <br />
          Anyone can take the survey and the result will be shown to the user
          who created this survey.
          <br />
          <br />
          Used <HighLight isDark>EJS template</HighLight> as frontend,{" "}
          <HighLight isDark>Express.js, Node.js, MongoDB</HighLight> as backend.
        </p>
      </div>
    ),
    links: [
      ...
      {
        content: "https://github.com/Hanqing1234/survey-management-project",
        image: github,
      },
    ],
    techUsed: [
  ...
  },
  {
    ...
    links: [
      ...
      {
        content: "https://github.com/Hanqing1234/places-share-web",
        image: github,
      },
    ],
    techUsed: [
  ...
  },
  {
    ...
    links: [
      ...
      {
        content: "https://github.com/Hanqing1234/react-food-order-app",
        image: github,
      },
    ],
    techUsed: [
  ...
  },
  {
    ...
    description: (
      <div>
        <p>
          This is my portfolio website. Used{" "}
          <HighLight isDark>React, Typescript, Sass</HighLight>.
        </p>
      </div>
    ),
    links: [
      ...
      {
        content: "https://github.com/Hanqing1234/Portfolio-Han",
        image: github,
      },
    ],
    techUsed: [
  ...
  },
  {
    logo: leetcode,
    title: "Leetcode",
    content: <Image src={myLeetcode} />,
    description: (
      <div>
        <p>
          Solving data structure and algorithm problems, still in progress.
          <br />
          <br />
          Used <HighLight isDark>JavaScript</HighLight>.
        </p>
      </div>
    ),
    links: [{ content: "https://leetcode.com/Han1016/", image: leetcode2 }],
